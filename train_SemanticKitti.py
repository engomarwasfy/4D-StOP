...
if __name__ == '__main__':
    ...
    if previous_training_path:
        ...
        chkp_path = os.path.join('/globalwork/kreuzberg/4D-PLS/results', previous_training_path, 'checkpoints')
    ...
    if previous_training_path:
        path = os.path.join('/globalwork/kreuzberg/4D-PLS/results', previous_training_path)
        config.load(path)
        config.saving_path = None
        #config.saving_path = path
    config.max_epoch = 800#300
    ...
    config.train_path = '/globalwork/kreuzberg/4D-PLS/results'
