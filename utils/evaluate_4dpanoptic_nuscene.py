...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=str,
        #required=True,
        default='/nodes/hoppiness/work/kreuzberg/Panoptic-Nuscene-SK-Format/dataset',
    ...
    parser.add_argument(
        ...
        default="valid",
        help=f'Split to evaluate on. One of {str(splits)}. Defaults to %(default)s',
    )
    ...
    parser.add_argument(
        ...
        type=str,
        #required=True,
        default='/nodes/hoppiness/work/kreuzberg/Panoptic-Nuscene-SK-Format/dataset/nuscene.yaml',
    ...
    test_sequences = list(range(700,850))
